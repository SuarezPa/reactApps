...
Pequeña aplicación creada con Vite + React que muestra personajes de Rick & Morty. Incluye componentes básicos, estilos y un servicio HTTP para consumir datos.

## Estructura principal
- `index.html` — Punto de entrada HTML. (appRick&Morthy/index.html)
- `src/main.jsx` — Monta la app React y renderiza el componente principal. (appRick&Morthy/src/main.jsx)
- `src/AppCharaters.jsx` — Componente principal que lista personajes. (appRick&Morthy/src/AppCharaters.jsx)
...
- `package.json` — Scripts y dependencias. (appRick&Morthy/package.json)
...
## Notas
- El componente principal es `AppCharaters` y usa tarjetas definidas en `Card`.
- Las llamadas a la API se gestionan desde `src/services/http-service.js`; ajusta endpoints en `src/constans.js` si es necesario.
- Para reglas de linter revisa la configuración de ESLint del proyecto.
